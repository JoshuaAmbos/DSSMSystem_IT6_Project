...
<head>
    ...
    <title>Receipt - {{ $transactionHeader->transaction_number }}</title>
    ...
    <div class="container receipt">
        <div class="text-center border p-4">
            ...
            <div class="border-top border-bottom my-3 py-3 text-start">
                <p class="mb-1"><strong>Receipt:</strong> {{ $transactionHeader->transaction_number }}</p>
                        ...
                        <tr>
                            <td class="text-start">
                                ...
                                <small class="text-muted">
                                    {{-- Using aliases: qty_sold and unit_price --}}
            ...
            <div class="border-top border-bottom my-3 py-2">
                <div class="d-flex justify-content-between fw-bold fs-5">
                    <span>TOTAL:</span>
                    <span>₱{{ number_format($receiptItems->sum('subtotal'), 2) }}</span>
                </div>
            </div>
